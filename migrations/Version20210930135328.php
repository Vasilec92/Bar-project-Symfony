 ...
 */
final class Version20210930135328 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `like` (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE like_beer (like_id INT NOT NULL, beer_id INT NOT NULL, INDEX IDX_8183BAD3859BFA32 (like_id), INDEX IDX_8183BAD3D0989053 (beer_id), PRIMARY KEY(like_id, beer_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
